...
<body>
  <div class="up-field">
    <a href="${pageContext.request.contextPath}/upload" class="btn">Upload
      Data From Excel</a> <a class="btn"
      href="${pageContext.request.contextPath}/downloadallcourse">Download
      Data</a>
  </div>
  <table>
    <tr>
